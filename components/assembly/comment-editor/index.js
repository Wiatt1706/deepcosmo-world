...
export const CommentEditor = ({ onCallback, showFormatToolbarDef = true, placeholder = 'Add to the discussion', isLoading = false, uploadImgSeting }) => {
    ...
    useKeyboardEvent(['Control', 'Enter'], () => { handleCallback() });
            ...
            {showFormatToolbar && (
                <div className={styles['format-toolbar']}>
                    <div className="d_c_c">
                        ...
                        {/* 添加图片按钮 */}
                        <ImageBtn handleSelect={handleImageSelect} uploadImgSeting={uploadImgSeting} />
                    </div>
                    <div className="d_c_c">
                        <div className="d_c_c">
                        ...
                        {isLoading ? (
                            ...
                            <button onClick={handleCallback} disabled={!text && (!files || files.length === 0)} className={styles.button_set_submit}>
